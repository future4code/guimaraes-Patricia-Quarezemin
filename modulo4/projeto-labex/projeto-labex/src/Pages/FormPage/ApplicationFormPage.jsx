...
const ApplicationFormPage = () => {
    ...
    const enviarFormulario = (e) => {
        ...
        axios
            .post(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/patricia-quarezemin-guimaraes/trips/${ListTripsPage.id}/apply`, body)
        ...
        <form onSubmit={enviarFormulario}>
            <MainContainer>
                ...
                <Main>
                    ...
                    <select required>
                        <option />
                        <option value='Netuno'>Surfando em Netuno</option>
                        <option value='Marte'>Festança Marciana</option>
                        <option value='Plutão'>Picni de Inverno em Plutão</option>
                        <option value='Júpiter'>Multi Luau em Júpiter</option>
                    </select>
                    <br />
                    <label htmlFor={"name"}>
                        Nome
                    ...
                    <label htmlFor={"applicationText"}>
                        Por que escolher <strong>VOCÊ:</strong>
                    </label>
                    <p><textarea
                        type="text"
                        id="descricao"
